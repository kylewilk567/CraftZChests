...
public class RegenAllCommand1_14 implements CommandExecutor {
	...
	public boolean onCommand(CommandSender sender, Command cmd, String label, String[] args) {
		...
		for(Location loc : locs) {
			...
			if(regenMang.getChestTimes().containsKey(Editor.getStringFromLocation(loc))) {
				Bukkit.getScheduler().cancelTask(regenMang.getChestTimes().get(Editor.getStringFromLocation(loc)).getFirst());
